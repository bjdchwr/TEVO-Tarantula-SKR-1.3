...
#define PRINTER_NAME "Jessica 2020"  // Change this to whatever you wish, or leave it as it is.
...
#define MOTHERBOARD BOARD_BIGTREE_SKR_V1_3        // Original controller board with built in stepper drivers. Works with MKS BASE 1.3, 1.4
 ...
 */
#define Z_STEPS      3200 // Stock lead screw
...
#define STRING_CONFIG_H_AUTHOR "(Dominic, Tarantula Super 2020)" // Who made the changes.
 ...
 */
#define MAX_BED_POWER 165 // limits duty cycle to bed; 255=full current
 ...
 */
#if ENABLED(DUAL_EXTRUDER)
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, Z_STEPS, E0_STEPS, E1_STEPS }
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, Z_STEPS, E0_STEPS }
#endif
