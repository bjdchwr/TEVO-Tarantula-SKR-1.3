...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT      13  // (mm) Unload initial retract length. Bug fix Dom
  #define FILAMENT_UNLOAD_PURGE_DELAY             5000  // (ms) Delay for the filament to cool after retract. Bug fix Dom
