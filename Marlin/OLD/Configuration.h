...
#define PRINTER_NAME "Dom 3D Printer"  // Change this to whatever you wish, or leave it as it is.
 ...
 */
#define E0_STEPS      200 // Stock extruder. If you have a Tevo Titan, try 400 then calibrate.
...
#define X_BED_SIZE 200//was 200
#if ENABLED(LARGE_BED)
  #define Y_BED_SIZE 240//was 240
#else
